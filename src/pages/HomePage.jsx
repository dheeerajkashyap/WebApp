      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1">
          ...
          <section className="relative min-h-[90vh] flex items-center overflow-hidden">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1620121478247-ec786b9be2fa"
                alt="Abstract data visualization with flowing networks and geometric patterns representing advanced analytics"
